import { getTeamLogo } from "../../core/utils/getTeamLogo.js";

export const GameCard = ({ date, homeTeam, visitorTeam, homeAcronym, visitorAcronym, onFollow }) => {
  return (
    <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-5 mb-5 transition-shadow hover:shadow-md">
      ...
      <button 
        onClick={onFollow}
        className="w-full bg-orange-500 hover:bg-orange-600 text-white font-bold py-3 px-4 rounded-xl transition-colors active:scale-[0.98]"
      >
        Seguir Partido
      </button>
    </div>
